...
from classes.game_classes.pacman import Pacman
from classes.statistic_classes.scores import Scores
from classes.statistic_classes.stats import Stats
...
def run_game(arr=False):
    ...
    while run:
        ...
        run = controls.events(pacman, run, screen)
        if not run:
            return stats.score
